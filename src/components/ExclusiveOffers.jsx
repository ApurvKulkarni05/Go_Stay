...
import { assets, exclusiveOffers } from '../assets/assets'; // Adjust the path as necessary
...
const ExclusiveOffers = () => {
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
      ...
      -between-w-full'>
        <Title align='left' title='EXCLUSIVE OFFERS' subTitle='Take advantage
        of our limited-time offers and special pacakges to enhance your stay and 
